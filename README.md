...
A TAP TEMPO on the interface didn't work for me, but I like this. It's not always accurate on some Genre's so it will probably go away.  I tap tempo, bad timing anyway.  Comment in the Forums or discussion here.
Things were tightened up and beautified.

![alt text](GrnRC1.jpg)


1. __Instructions are in the Document notes:__ they mmay not be as updated
